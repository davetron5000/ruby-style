...
Why? _Ensures that classnames are understood everywhere they're used._
...
#### The README should include additional info for developing with the code
...
Why? _It's important to establish what the mock expectation is, and thinking of it as separate from a given helps the test read better._
